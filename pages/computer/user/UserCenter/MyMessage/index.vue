    ...
    export default {
        ...
        methods: {
            ...
            userInfo () {
                ...
                axios.post('/api/v2/user/info/query', data)
                    .then(res => {
             ...
             */
            loginHistory () {
                let pageData = {traceId: tool.UUID(), data: {pageNo: this.current, pageSize: this.pageSize}}
                axios.post('/api/v2/user/login/histroy/query', pageData)
                    .then(res => {
                        if (res.data.code.toString() === '0000') {
                            this.data = []
