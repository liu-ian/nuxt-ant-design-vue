        ...
        <a-layout class="user-center-content">
            ...
            <a-layout style="padding-left:24px">
                <a-layout-content class="a-layout-content">
                    <message-info v-show="siderKey === '5'"></message-info>
                    <span v-show="siderKey !== '5'"></span>
                </a-layout-content>
            </a-layout>
        </a-layout>
        <fonter/>
...
<script>
    ...
    import MessageInfo from '~/pages/pc/UserCenter/MyMessage/index'
        ...
        methods: {
            ...
            changeView () {
                if (this.$route.query.getKey) {
                    this.getKey = [this.$route.query.getKey]
