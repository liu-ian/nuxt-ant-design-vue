            ...
            <a-layout-content>
                <div class="content content-register">
                    <div id="components-form-BindMailbox">
                        <p class="components-form-BindMailbox"> {{$t('ChangeMobileStepTwo.item-1')}} </p>
                        <a-form
                                :form="form"
                                :layout="formLayout"
                                class=""
    ...
    export default {
        ...
        methods: {
            ...
            submitCheck () {
                ...
                this.$axios.post('/v2/user/bind/change', {params})
                    .then(res => {
                        if (res.data.code.toString() === '0000') {
                            this.$message.success(res.data.msg)
                            // 成功 => 跳转
